...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PluginsSmartSnippetPointer'
        db.create_table('cmsplugin_pluginssmartsnippetpointer', (
            ('cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('snippet', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['smartsnippets.SmartSnippet'])),
        ))
        db.send_create_signal('smartsnippets', ['PluginsSmartSnippetPointer'])
    ...
    def backwards(self, orm):
        # Deleting model 'PluginsSmartSnippetPointer'
        db.delete_table('cmsplugin_pluginssmartsnippetpointer')
    ...
    models = {
        ...
        'smartsnippets.pluginssmartsnippetpointer': {
            'Meta': {'object_name': 'PluginsSmartSnippetPointer', 'db_table': "'cmsplugin_pluginssmartsnippetpointer'", '_ormbases': ['cms.CMSPlugin']},
