...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Variable.is_active'
        db.add_column('smartsnippets_variable', 'is_active', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Variable.is_active'
        db.delete_column('smartsnippets_variable', 'is_active')
